...
const sequelize = require("sequelize");     // sequelize est présent pour le formatage de la date
dotenv.config();    // utilisation des variables d'environnement
          ...
          message
            .update({
              ...
              image: req.file
                ...
                : message.image, // Utilisation de la syntaxe ternaire
            })
            .then((message) => {
              res.status(200).json({
